CUDA_VISIBLE_DEVICES=0,1,2,3 python train.py --py-config config/train_cascadeworld_ms_3_rqvaealign.py --work-dir out/rqworld_temporaldepth_attn_largestepcausal
