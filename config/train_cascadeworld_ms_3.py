...
return_len_train = 15
depth = 3
load_from = './out/RQVAEV2_stage1_depth4_codebook2048/epoch_193.pth' #recommend selecting the best vqvae model
port = 25095
revise_ckpt = 3
eval_every_epochs = 1
save_every_epochs = 1
...
loss = dict(
    ...
    loss_cfgs=[
        ...
        dict(
            ...
            weight=1.0,
            input_dict={
                'ce_inputs': 'ce_inputs_d',
                'ce_labels': 'ce_labels_d'}),
        dict(
...
loss_input_convertion = dict(
    ...
    ce_inputs_d = 'ce_inputs_d',
    ce_labels_d = 'ce_labels_d',
...
model = dict(
    ...
    vae = dict(
        ...
        expansion=expansion, 
        vqvae_cfg=dict(
            type='ResidualVectorQuantizerV2',
            dim = base_channel * 2,
            n_embed = n_e_,
        )
        #
    ...
    transformer_d=dict(
        ...
        num_tokens=1,
        num_frames=depth, # depth = 4 -> depth-1
        num_layers=2,
