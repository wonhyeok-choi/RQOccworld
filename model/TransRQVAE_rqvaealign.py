...
class TransRQVAEalign(BaseModule):
    ...
    def forward_train_with_plan(self, x, metas):
        ...
        if is_soft:
            residual_list, code_list, soft_code_list, shapes, out_shape = self.vae.encode_soft_code(x, temp=0.5, stochastic=False)
    ...
    def forward_inference_with_plan(self, x, metas):
        ...
        idx_1 = torch.argmax(z_q_1.flatten(0, 1).flatten(0, 1), dim=1)
